...
insert into medico (id, nss, nombre, apellidos, created_at, updated_at) values (1, 123451, 'nombre1', 'apellido11 apellido12', now(), now());
insert into medico (id, nss, nombre, apellidos, created_at, updated_at) values (2, 123452, 'nombre1', 'apellido11 apellido12', now(), now());
insert into medico (id, nss, nombre, apellidos, created_at, updated_at) values (3, 123453, 'nombre1', 'apellido11 apellido12', now(), now());
insert into medico (id, nss, nombre, apellidos, created_at, updated_at) values (4, 123454, 'nombre1', 'apellido11 apellido12', now(), now());
...
insert into tecnicogk (id, dni, nombre, apellidos, created_at, updated_at) values (1, '45671001A', 'tnombre1', 'tapellido11 tapellido12', now(), now());
insert into tecnicogk (id, dni, nombre, apellidos, created_at, updated_at) values (2, '45671002B', 'tnombre2', 'tapellido21 tapellido22', now(), now());
insert into tecnicogk (id, dni, nombre, apellidos, created_at, updated_at) values (3, '45671003C', 'tnombre3', 'tapellido31 tapellido32', now(), now());
insert into tecnicogk (id, dni, nombre, apellidos, created_at, updated_at) values (4, '45671004D', 'tnombre4', 'tapellido41 tapellido42', now(), now());
